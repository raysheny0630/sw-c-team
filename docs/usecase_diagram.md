...
- [o] 모든 FR(5개)이 유스케이스로 표현되어 있는가?
- [o] 액터가 실제 사용자 역할과 일치하는가?
- [o] 유스케이스 이름이 "동사 + 목적어" 형식인가?
- [o] `<<include>>` / `<<extend>>` 관계가 올바르게 사용되었는가?
- [o] 시스템 경계 안에 있어야 할 기능이 밖에 있지 않은가?
- [o] NFR은 유스케이스로 표현하지 않았는가?

---

*최종 수정: 2026-05-11 | 담당: 분석가*
