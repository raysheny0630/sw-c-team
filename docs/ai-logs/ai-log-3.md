...
**작성자**: 설계자  
**대상 기간**: 11~12주차 (M2 설계, 계획 10주차 작업의 지연 수행)  
...
`docs/class_diagram.md`의 클래스 다이어그램 설명서 섹션에 최종 반영을 완료함. 클래스 간 책임을 명확히 구분한 정상 시나리오 단계를 확정하고, 분리된 컴포넌트별 예외 대응 로직을 세부 서술로 구체화하여 명시함.
...
> *정정 이력 (2026-06-12, 6/11 회의 결정)*: ① 대상 기간을 실제 작성·반영 시점(5/15~5/18) 기준 11~12주차로 정정 ② 건별 #1·#2의 최종 반영 위치 경로 오기를 `docs/class_diagram.md`로 정정.
