...
> **대상 산출물**: `docs/usecase_diagram.md`
> **작성자**: 분석가
> **대상 기간**: 11주차 (M2 설계 착수)
...
`docs/usecase_diagram.md`에 반영 완료.  
...
`docs/usecase_diagram.md`의 유스케이스 설명서 섹션에 반영 완료.  
...
> *정정 이력 (2026-06-12, 6/11 회의 결정)*: 최종 반영 위치 2곳의 경로 오기 `docs/design/usecase_diagram.md` → `docs/usecase_diagram.md` 정정.
