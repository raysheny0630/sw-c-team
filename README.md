...
| [유스케이스 다이어그램](docs/usecase_diagram.md) | UC-FR 대응표, include/extend 관계, 유스케이스 설명서 |
| [클래스 다이어그램](docs/class_diagram.md) | 클래스 도출 근거, 관계 기수성, Mermaid classDiagram |
| [객체지향 설계](docs/oo_design.md) | 패키지 다이어그램, 3계층 아키텍처, DB 테이블 설계, UI 내비게이션 |
